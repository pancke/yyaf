<?php
class Controller_Admin_Credit extends Controller_Admin_Base
{
    ...
    public function listAction ()
    {
        ...
        $aList = Model_User::getList($aWhere, $iPage,'iUserID desc');
    ...
    public function addAction ()
    {
        if ($this->_request->isPost()) {
            ...
            if (Model_User::getRow(array('where' => array('iType' => $aUser['iType'] , 'sEmail' => $aUser['sEmail'] , 'iStatus IN ' => '1,2')))) {
                return $this->showMsg('用户已经存在！', false);
            }
    ...
    public function explodeAction(){
        ...
        foreach ($aList as $key => $val) {
            ...
            $sCoIndustry = '';
            if($val['sCoIndustry'] != '') {
                $rowlevel = Model_Domain::getAll(array('where' => array('iAutoID IN' => $val['sCoIndustry'])));//合作等级
