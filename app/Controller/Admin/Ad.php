...
class Controller_Admin_Ad extends Controller_Admin_Base
{
    ...
    public function listAction()
    {
		...
		if (! empty($aParam['iPut']) && $aParam['iPut'] != '') {
    ...
    public function _checkData($sType = 'add')
    {
        ...
        $sAdName = $this->getParam('sAdName');
        $iPlanMinMoney = $this->getParam('iPlanMinMoney');
        $iPlanMaxMoney = $this->getParam('iPlanMaxMoney');
        $iPlanTime = $this->getParam('iPlanTime');
        $iMediaType = $this->getParam('iMediaType');
        $iAdType = $this->getParam('iAdType');
		$iExplain = $this->getParam('iExplain');

        $sCatID = $this->getParam('sCatID');
        if (empty($sCatID)){
        	$sCatID = '';
        }else{
        	$sCatID = join(',', $sCatID);
        ...
        $iTotalMoney = $this->getParam('iTotalMoney');
        ...
        $aRow = array(
            'iUserID' => $iUserID,
            'sAdName' => $sAdName,
            'iPlanMinMoney' => $iPlanMinMoney,
            'iPlanMaxMoney' => $iPlanMaxMoney,
            'iPlanTime' => $iPlanTime,
