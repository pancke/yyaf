 ...
 * 自媒体管理
 */
class Controller_Admin_Mediash extends Controller_Admin_Base
{
...
//             }
    ...
    public function explodeAction() {
    	...
    	foreach ($aList as $key => $val){
    		...
    		$str_explode .= '<tr>
								...
								<td align="left">'.$iPrice1.'</td>
								<td align="left">'.$iPrice2.'</td>
								<td align="left">'.$iPrice3.'</td>
								<td align="left">'.$iPrice4.'</td>
    ...
    public function _checkData($sType = 'add')
    {
        ...
        $iPrice11 = $this->getParam('iPrice11');
        $iPrice12 = $this->getParam('iPrice12');
        $iPrice13 = $this->getParam('iPrice13');
        $iPrice14 = $this->getParam('iPrice14');
